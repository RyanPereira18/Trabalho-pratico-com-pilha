...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
         ...
         void mostraPilha(Stack<Produto> pilha, JTextArea meuList){
        meuList.setText("");         
        for(Produto p:pilha)meuList.append(p + "\n");      
    }// fim funcao         
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
         String produtoProcurado = txtProduto.getText();
    int quantidadeRemover = Integer.parseInt(txtQuantidade.getText());
    Pilha<Produto> minhaPilhaAuxiliar = new Pilha<>();
    
    while (!minhaPilha.isEmpty()) {
        Produto p = minhaPilha.peek();
        if (p.getDescricao().equals(produtoProcurado)) {
            if (p.getQtd() <= quantidadeRemover) {
                minhaPilha.pop();
                JOptionPane.showMessageDialog(null, "Produto removido com sucesso!");
                break;
            } else {
                Produto novoP = new Produto(p.getDescricao(), p.getQtd() - quantidadeRemover);
                minhaPilha.pop();
                minhaPilha.push(novoP);
                JOptionPane.showMessageDialog(null, "Quantidade de produto removida com sucesso!");
                break;
            }
        } else {
            Produto pAux = minhaPilha.pop();
            minhaPilhaAuxiliar.push(pAux);
        }
    }
    
    while (!minhaPilhaAuxiliar.isEmpty()) {
        Produto pAux = minhaPilhaAuxiliar.pop();
        minhaPilha.push(pAux);
    }
